...
%define		qtbase_ver		5.6.3
%define		qtdeclarative_ver	5.6.3
%define		qttools_ver		5.6.3
...
Group:		Libraries
Source0:	http://download.qt.io/archive/qt/5.6/5.6.3/submodules/%{orgname}-opensource-src-%{version}.tar.xz
# Source0-md5:	9f0d433ffec03b29c4ef11e7bcdc495a
URL:		http://www.qt.io/
...
Requires:	Qt5Enginio = %{epoch}:%{version}-%{release}
